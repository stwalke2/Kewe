...
export function BusinessObjectTypeDetailPage() {
  ...
  return <section className='page-section'><h2>Business Object Type: {model.code}</h2>
    ...
    <button className='btn btn-primary' onClick={()=>void updateBusinessObjectType(model.code, model)}>Save Type</button>
  </section>;
}
